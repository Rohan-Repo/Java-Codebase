...
public class ClassRecordEg {
    public static void main(String[] args) {
        ...
        EmployeeCls empCls1 = new EmployeeCls( 1, "John Doe", "IT", 100000 );
        System.out.println("empCls1 = " + empCls1);
        EmployeeCls empCls2 = new EmployeeCls( 2, "Jane Doe", "Sales", 75000 );
        System.out.println("empCls2 = " + empCls2);

        EmployeeRecord empRcrd1 = new EmployeeRecord( 1, "John Doe", "IT", 100000 );
        System.out.println("empRcrd1 = " + empRcrd1);
        EmployeeRecord empRcrd2 = new EmployeeRecord( 2, "Jane Doe", "Sales", 75000 );
